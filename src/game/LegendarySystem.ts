...
export const LEGENDARIES: readonly LegendaryDefinition[] = [
  {
    ...
    desc: 'Копии наносят 45% урона. Максимум две генерации; projectile pool остаётся жёстким пределом.',
  ...
  },
  {
    ...
    desc: 'Вторичный импульс наносит 30% lysis-урона с короткой задержкой и не создаёт рекурсивных цепей.',
    archetype: 'lysis',
    stage: 'any',
    weight: 1,
  ...
  },
  {
    ...
    desc: 'Притяжение длится 2,5 секунды. Боссы не перемещаются; эффект использует существующий enemy pool.',
    archetype: 'control',
    stage: 'any',
    weight: 0.9,
    prerequisites: [],
  ...
  },
  {
    id: 'core-predator',
    title: 'ХИЩНИК ЯДРА',
    effect: 'Четыре последовательных попадания открывают Core Window на 1,5 секунды',
    desc: 'В окне урон по elite/boss цели +75%. Обычные swarm-цели не получают бонус.',
    archetype: 'boss',
    stage: 'any',
    weight: 1,
    prerequisites: [],
  ...
  },
  {
    ...
    title: 'РИТМ МИОКАРДА',
    effect: 'Первое попадание после heartbeat impact выпускает усиленную radial wave',
    desc: 'Только Heart. Окно длится 650 мс и расходуется один раз на heartbeat.',
    archetype: 'heartbeat',
    stage: 'heart',
    weight: 1.15,
    prerequisites: [],
  ...
  },
  {
    ...
    effect: 'Один раз за забег предотвращает смерть и оставляет 1 HP',
    desc: 'Экран очищается от обычных врагов, текущий RNA/XP уменьшается на 25%, mutation form длится 8 секунд.',
    archetype: 'survival',
    stage: 'any',
    weight: 0.72,
    prerequisites: [],
