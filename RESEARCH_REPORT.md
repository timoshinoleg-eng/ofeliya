...
| 7 | Звук | **Tone.js** — [repo](https://github.com/Tonejs/Tone.js) | MIT, 14.7k★ | Генеративная музыка без семплов (синтезаторы) | 90% | Новый MusicSystem поверх `Sfx.ts`; ⚠ бандл ~150 КБ gzip — только lazy-load в меню | **12** |
...
- Tone.js: точный вес бандла замерить при внедрении; если >150 КБ gzip — только lazy-load.
